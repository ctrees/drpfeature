====================
drpfeature-test-drpe
====================

Intent
  This is the **drpfeature-test-drpe** setup for the drp-provision endpoint used in drpfeature-test_ setup.
Success
  RackN-Portal_ setup to PXE boot nodes on an isolated network so broadcast messages are easy to monitor.
